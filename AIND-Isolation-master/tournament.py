...
from game_agent import my_heuristic1,my_heuristic2,haoshan_heuristic,sinmei_heuristic
...
def main():
    ...
    test_agents = [Agent(CustomPlayer(score_fn=my_heuristic1, **CUSTOM_ARGS), "CHEAH JO YEN"),
                   Agent(CustomPlayer(score_fn=my_heuristic2, **CUSTOM_ARGS), "CHEAH JO YEN-2"),
                   
                   Agent(CustomPlayer(score_fn=haoshan_heuristic, **CUSTOM_ARGS), "WONG HAO SHAN"),
                   Agent(CustomPlayer(score_fn=sinmei_heuristic, **CUSTOM_ARGS), "CHONG SIN MEI "),
